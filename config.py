...
COMPANIES = [
    ...
    {"name": "Allogene Therapeutics", "category": "异体/现货型CAR-T",
     ...
     "product_keywords": ["cema-cel", "allo-501", "allo-715"],
    ...
    {"name": "Caribou Biosciences", "category": "异体/现货型CAR-T",
     ...
     "product_keywords": ["cb-010", "cb-011", "vispa-cel"],
    ...
    {"name": "CRISPR Therapeutics", "category": "异体/现货型CAR-T",
     ...
     "product_keywords": ["ctx110", "ctx112", "ctx130", "casgevy"],
    ...
    {"name": "Century Therapeutics", "category": "异体/现货型CAR-T",
     ...
     "product_keywords": ["cnty-101", "cnty-102"],
    ...
    {"name": "Autolus Therapeutics", "category": "自体下一代CAR-T",
     ...
     "product_keywords": ["obe-cel", "obecabtagene", "auto1"],
    ...
    {"name": "Affini-T Therapeutics", "category": "实体瘤CAR-T/TCR-T",
     ...
     "product_keywords": ["afnt-111", "afnt-211"],
    ...
    {"name": "Immatics", "category": "实体瘤CAR-T/TCR-T",
     ...
     "product_keywords": ["ima401", "ima402", "ima203", "actengine"],
    ...
    {"name": "Immunocore", "category": "实体瘤CAR-T/TCR-T",
     ...
     "product_keywords": ["kimmtrak", "tebentafusp", "imc-f106c"],
    ...
    {"name": "Adaptimmune Therapeutics", "category": "实体瘤CAR-T/TCR-T",
     ...
     "product_keywords": ["afami-cel", "tecelra", "lete-cel"],
    ...
    {"name": "Legend Biotech", "category": "在位者大药企",
     ...
     "product_keywords": ["carvykti", "cilta-cel", "lcar-b38m"],
    ...
    {"name": "CARsgen Therapeutics (科济药业)", "category": "Ronde-cel竞品(LBCL)",
     ...
     "ct_keywords": ["satri", "ct041", "ct1190", "car-t", "car t",
    ...
    {"name": "北京艺妙神州 (Immunochina)", "category": "LYL273竞品(mCRC)",
     ...
     "product_keywords": ["im96", "gucy2c"],
     "ct_keywords": ["im96", "gucy2c", "car-t", "car t", "chimeric antigen"]},
    ...
    {"name": "Agenus", "category": "10-K潜在竞品",
     ...
     "product_keywords": ["balstilimab", "botensilimab"],
